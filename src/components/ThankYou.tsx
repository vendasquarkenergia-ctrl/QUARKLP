...
export default function ThankYou() {
  return (
    <section className="min-h-[100svh] flex items-center justify-center px-6 py-24 relative overflow-hidden bg-transparent">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-quark-green/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-2xl mx-auto text-center relative z-10">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6">Análise Iniciada</h1>

          <p className="text-xl text-slate-400 mb-10 leading-relaxed font-sans">
            Nossa equipe de engenharia já recebeu seus dados e está calculando o seu potencial de economia.
          </p>

          <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/5 border border-amber-500/20 rounded-3xl p-8 mb-12 relative overflow-hidden text-left flex gap-6 items-start shadow-lg">
            ...
            <div>
              ...
              <p className="text-amber-500/80 font-medium leading-relaxed font-sans">
                Nossos diretores analisarão seu perfil. Fique com o celular em mãos, nosso contato é imediato e as vagas para projetos com condições especiais este mês são limitadas.
              </p>
            </div>
          </div>

          <div className="space-y-4">
            <p className="text-slate-500 text-sm uppercase tracking-widest font-bold">Não quer esperar?</p>
